...
public extension UIViewController {
    func presentAlert(title: String, message: String? = nil, okText: String, cancelText: String? = nil, okHandler: ((UIAlertAction) -> Void)? = nil, cancelHandler: ((UIAlertAction) -> Void)? = nil, textFieldConfigurationHandler: ((UITextField) -> Void)? = nil, completion: (() -> Void)? = nil) {

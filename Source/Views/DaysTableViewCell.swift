...
class DaysTableViewCell: UITableViewCell {
    ...
    private func setupConstraints() {
        ...
        constraints.append(stackView.topAnchor.constraint(equalTo: contentView.layoutMarginsGuide.topAnchor))
        constraints.append(stackView.bottomAnchor.constraint(equalTo: contentView.layoutMarginsGuide.bottomAnchor))

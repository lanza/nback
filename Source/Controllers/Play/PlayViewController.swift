...
class PlayViewController: ViewController, HasContext {
    ...
    override func loadView() {
        ...
        playGameButton = UIButton.button(title: Lets.playl10n, target: self, selector: #selector(newGameButtonTapped), font: Theme.Fonts.playLabels)
    ...
    var newGameTapped: ((PlayViewController) -> ())!
}
